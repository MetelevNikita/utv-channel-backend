...
const postNews = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!req.files.file_1) {
            ...
            endFolder = path_1.default.parse(findImage[0].destination).base.split('\\').slice(-1);
        }
        ...
        const arrOfFiles = Object.values(req.files).map((item, index) => {
