...
const updateNews = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id, title, lead, author, date, video, text_1, image_comment_1, comment_1, text_2, image_comment_2, comment_2, text_3, image_comment_3, comment_3, text_4, image_comment_4, comment_4, text_5, image_comment_5, comment_5, text_6, image_comment_6, comment_6, text_7, image_comment_7, comment_7, text_8, image_comment_8, comment_8, text_9, image_comment_9, comment_9, text_10, image_comment_10, comment_10, tags, views, news_description, title_image } = req.body;
        let fullUrl = 'https://utvchannel.tw1.su' + `/image/news/${day}/`;
        const updateNews = yield database_1.pool.query(`UPDATE news SET title = $1, lead = $2, author = $3, date = $4, video = $5,  text_1 = $6, comment_1 = $7, image_1 = $8, image_comment_1 = $9, text_2 = $10, comment_2 = $11, image_2 = $12, image_comment_2 = $13, text_3 = $14, comment_3 = $15, image_3 = $16, image_comment_3 = $17, text_4 = $18, comment_4 = $19, image_4 = $20, image_comment_4 = $21, text_5 = $22, comment_5 = $23, image_5 = $24, image_comment_5 = $25, text_6 = $26, comment_6 = $27, image_6 = $28, image_comment_6 = $29, text_7 = $30, comment_7 = $31, image_7 = $32, image_comment_7 = $33, text_8 = $34, comment_8 = $35, image_8 = $36, image_comment_8 = $37, text_9 = $38, comment_9 = $39, image_9 = $40, image_comment_9 = $41, text_10 = $42, comment_10 = $43, image_10 = $44, image_comment_10 = $45, tags = $46, views = $47, news_description = $48, title_image = $49 WHERE id = $50`, [title, lead, author, date, video, text_1, comment_1, (req.files.file_1) ? fullUrl + req.files.file_1[0].originalname : req.body.file_1, image_comment_1, text_2, comment_2, (req.files.file_2) ? fullUrl + req.files.file_2[0].originalname : req.body.file_2, image_comment_2, text_3, comment_3, (req.files.file_3) ? fullUrl + req.files.file_3[0].originalname : req.body.file_3, image_comment_3, text_4, comment_4, (req.files.file_4) ? fullUrl + req.files.file_4[0].originalname : req.body.file_4, image_comment_4, text_5, comment_5, (req.files.file_5) ? fullUrl + req.files.file_5[0].originalname : req.body.file_5, image_comment_5, text_6, comment_6, (req.files.file_6) ? fullUrl + req.files.file_6[0].originalname : req.body.file_6, image_comment_6, text_7, comment_7, (req.files.file_7) ? fullUrl + req.files.file_7[0].originalname : req.body.file_7, image_comment_7, text_8, comment_8, (req.files.file_8) ? fullUrl + req.files.file_8[0].originalname : req.body.file_8, image_comment_8, text_9, comment_9, (req.files.file_9) ? fullUrl + req.files.file_9[0].originalname : req.body.file_9, image_comment_9, text_10, comment_10, (req.files.file_10) ? fullUrl + req.files.file_10[0].originalname : req.body.file_10, image_comment_10, tags, 0, news_description, (req.files.title_image) ? fullUrl + req.files.title_image[0].originalname : '', id]);
        if (!updateNews.rows) {
            res.status(404).send('Новости не созданы');
            return;
        }
